...
myWear = Wear('shoes', "XL")
print(myWear.type)
print(myWear.size)
```
### Результат
<img width="1709" height="273" alt="image" src="https://github.com/user-attachments/assets/dbe13982-3321-4728-b4a1-4300fc747547" />

### Вывод
Я научился создавать класс и его объект
...
class Wear:
    ...
    def putInTheCloset(self):
        self.inCloset = True
        print('Одежда положена в шкаф')


myWear = Wear('shoes', "XL")
print(myWear.type)
print(myWear.size)
myWear.putInTheCloset()
```
### Результат
<img width="1713" height="276" alt="image" src="https://github.com/user-attachments/assets/814e9982-1f25-4a61-8825-060874ce6632" />

### Вывод
Я научился добавлять атрибуты и методы в класс.
